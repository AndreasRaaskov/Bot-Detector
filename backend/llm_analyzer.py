...
class LLMAnalyzer:
    ...
    def __init__(self, api_keys: Dict[str, str], default_models: Optional[Dict[str, str]] = None):
        ...
        self.default_models = default_models or {
            ...
            "anthropic": "claude-sonnet-4-5-20250929",  # Fast and cost-effective
        ...
        You are analyzing a social media account to detect bots, spam, and suspicious automated activity.

        Please analyze the following content and determine if this account exhibits bot-like behavior:
        ...
        1. **AI-generated content**: Does the text appear to be written by AI? (repetitive patterns, overly formal, templated)
        2. **Spam/promotional**: Is this account primarily promoting products, services, adult content, crypto, or scams?
        3. **Automated behavior**: Does the posting pattern or content suggest automation? (identical posts, scheduled content)
        4. **Sex/adult bot**: Does the bio or content contain adult/sexual content, OnlyFans links, Telegram links with suggestive emojis?
        5. **Scam indicators**: Crypto schemes, investment scams, fake giveaways, phishing attempts
        6. **Legitimate human**: Normal human conversation, personality, varied content

        Based on your analysis, please provide:
        - **assessment**: "bot" (for spam/automated/AI bots) or "human" (for legitimate accounts)
        - **confidence**: Your confidence level (0-100%)
        - **indicators**: List of specific red flags or green flags you found
        - **reasoning**: Brief explanation focusing on bot-like behavior, spam, automation, or human authenticity
        ...
        {{
            ...
            "reasoning": "Brief explanation of whether this is a bot/spam account or legitimate human"
        }}
        """
    ...
    def _parse_llm_response(self, response_text: str, model_name: str) -> LLMAnalysisResult:
        ...
        try:
            ...
            if json_start >= 0 and json_end > json_start:
                ...
                if assessment == "bot" or assessment == "ai":
